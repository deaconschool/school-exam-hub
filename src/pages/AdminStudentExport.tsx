...
const AdminStudentExport = () => {
  ...
  return (
    <AdminLayout title="Export Results" subtitle="Export student grading results to Excel">
      {/* Header Actions */}
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-white/20 p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm font-bold text-green-600">Export Mode</p>
              </div>
            </div>
          </Card>
...
export default AdminStudentExport;